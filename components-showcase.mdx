---
title: "组件展示大全"
description: "展示 Mintlify 所有支持的内置 MDX 组件，包括布局、强调、导航和 API 文档组件。"
---
...
<Tabs>
  <Tab title="简介">
    Tabs 用于将相关内容组织成可切换的标签视图，让页面更整洁。
  </Tab>
  <Tab title="示例代码">
    ```python
    def hello():
        print("Hello, Qwen Cloud!")
    ```
  </Tab>
  <Tab title="注意事项">
    每个 Tab 必须有唯一的 `title` 属性。
  </Tab>
</Tabs>
...
<AccordionGroup>
  ...
  <Accordion title="Credit 用完了怎么办？" icon="circle-alert">
